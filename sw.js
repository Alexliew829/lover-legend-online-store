const CACHE = "lover-legend-online-store-v2.2-identity-isolated";
const SCOPE_PATH = "/lover-legend-online-store/";
const CORE = [
  "./",
  "./index.html?v=22-online-identity-isolated",
  "./css/style.css?v=22-online-identity-isolated",
  "./js/common.js?v=22-online-identity-isolated",
  "./js/sync.js?v=22-online-identity-isolated",
  "./js/app.js?v=22-online-identity-isolated",
  "./manifest.json?v=22-online-identity-isolated",
      ...
      fetch(event.request, { cache: "no-store" })
        .then(response => {
          if (response && response.ok) {
            ...
            caches.open(CACHE).then(cache => cache.put("./index.html?v=22-online-identity-isolated", copy));
          }
          return response;
        })
        .catch(async () => (await caches.match("./index.html?v=22-online-identity-isolated")) || (await caches.match("./index.html")))
    );
    return;
  }
