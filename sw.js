const CACHE = "lover-legend-online-store-v2.3-identity-isolated";
const SCOPE_PATH = "/lover-legend-online-store/";
const CORE = [
  "./",
  "./index.html?v=23-online-readonly-price-sync",
  "./css/style.css?v=23-online-readonly-price-sync",
  "./js/common.js?v=23-online-readonly-price-sync",
  "./js/sync.js?v=23-online-readonly-price-sync",
  "./js/app.js?v=23-online-readonly-price-sync",
  "./manifest.json?v=23-online-readonly-price-sync",
      ...
      fetch(event.request, { cache: "no-store" })
        .then(response => {
          if (response && response.ok) {
            ...
            caches.open(CACHE).then(cache => cache.put("./index.html?v=23-online-readonly-price-sync", copy));
          }
          return response;
        })
        .catch(async () => (await caches.match("./index.html?v=23-online-readonly-price-sync")) || (await caches.match("./index.html")))
    );
    return;
  }
